...
def create_diagram(title, nodes, edges, node_labels=None, node_types=None, edge_labels=None):
    ...
    pos["German Language Specialist"] = (2*horizontal_spacing, 0)
...
def extended_uluru_exercise():
    ...
    edges = [
        ...
        ("Language Identification", "German Language Specialist"),
        ("German Language Specialist", "Language Identification"),
        ("German Language Specialist", "Knowledge Base Lookup"),
        ("Knowledge Base Lookup", "German Language Specialist"),
    ]
    ...
    node_types = {
        ...
        "German Language Specialist": "agent"
